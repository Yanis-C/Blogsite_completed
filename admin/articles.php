...
// @todo_done décommenter ce code une fois toutes les fonctions codées
...
$firstPag = $page == 1 ? 1 : $page - 1;
?>

<!-- @todo_done coder la boucle foreach pour afficher les articles -->
...
<!-- @todo_done coder la boucle foreach pour gérer les pages -->
<?php if ($totalPages > 1): ?>
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      ...
      <?php endif; ?>
      <?php for($i = $firstPag; $i<=$totalPages; $i++) : ?>
